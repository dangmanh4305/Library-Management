...
namespace QLTV
{
    public partial class frmStaffManager : Form
    {
        ...
        public frmStaffManager()
        {
            ...
            LoadComboBoxes();
            CustomizeUI();
            // Load data ngay khi mở form để hiển thị danh sách nhân viên
            LoadData();
            // Đặt mặc định trạng thái nếu có
        ...
        private void LoadComboBoxes()
        {
            ...
            // Validate that the DataTable contains the expected columns before binding
            if (dtRoles == null || dtRoles.Columns.Count == 0 || !dtRoles.Columns.Contains("RoleName") || !dtRoles.Columns.Contains("RoleID"))
            {
                // Disable the combo box to avoid binding exceptions and notify user
                cbRole.DataSource = null;
                cbRole.Items.Clear();
                cbRole.Enabled = false;
                // Optionally inform the user (Controller already shows detailed DB error)
                MessageBox.Show("Không thể load danh sách chức vụ. Vui lòng kiểm tra kết nối cơ sở dữ liệu.", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            User newUser = new User
            {
                ...
                RoleID = cbRole.Enabled && cbRole.SelectedValue != null ? Convert.ToInt32(cbRole.SelectedValue) : 0 // Nếu không load được chức vụ, đặt 0 (hoặc xử lý tuỳ yêu cầu)
            };
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            User editUser = new User
            {
                ...
                Email = txtEmail.Text,
                Status = cbStatus.Text,
                RoleID = cbRole.Enabled && cbRole.SelectedValue != null ? Convert.ToInt32(cbRole.SelectedValue) : 0 // Nếu không load được chức vụ, đặt 0
            };
